...
{
    /// <summary>
    /// Driver for the Rohde &amp; Schwarz SMT (SMT02/SMT03) signal generator — a SCPI (IEEE-488.2) instrument.
    /// CW frequency/power/RF-on-off over any <see cref="IInstrumentSession"/> (issue #138).
    /// </summary>
    public sealed class RohdeSchwarzSmt : ISignalSource
    {
        /// <summary>GPIB address of the SMT — factory default 28. Override with <c>--address</c>.</summary>
        public const string DefaultResource = "GPIB0::28::INSTR";

        private readonly IInstrumentSession _session;
        private readonly List<string> _history = new List<string>();

        public RohdeSchwarzSmt(IInstrumentSession session) =>
